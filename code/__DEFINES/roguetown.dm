...
#define ARMOR_PADDED_WEAK	list("blunt" = 15, "slash" = 10, "stab" = 10, "piercing" = 5, "fire" = 0, "acid" = 0)
#define ARMOR_PADDED_BAD	list("blunt" = 25, "slash" = 15, "stab" = 15, "piercing" = 15, "fire" = 0, "acid" = 0)
...
#define ARMOR_LEATHER_WEAK	list("blunt" = 20, "slash" = 20, "stab" = 20, "piercing" = 5, "fire" = 0, "acid" = 0)
...
#define ARMOR_LEATHER_APEX	list("blunt" = 80, "slash" = 70, "stab" = 50, "piercing" = 30, "fire" = 0, "acid" = 0)
...
// Heavy AC
#define ARMOR_PLATE_WEAK	list("blunt" = 75, "slash" = 75, "stab" = 75, "piercing" = 55, "fire" = 0, "acid" = 0)
